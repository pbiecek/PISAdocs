...
You can download raw data from PISA website \cite{PISAwebsite}. The raw data is available as compressed text files and you can read these files with the \verb:read.fwf(): function. \margin{The \texttt{read.fwf()} function is a standard way to read text files in the fixed width format.} 
...
In next chapters we wll show some usefull functions that avaliable there.
